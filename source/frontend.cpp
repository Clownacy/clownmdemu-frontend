...
static constexpr int FRAMEBUFFER_WIDTH = VDP_MAX_SCANLINE_WIDTH;
static constexpr int FRAMEBUFFER_HEIGHT = VDP_MAX_SCANLINES;
...
void Frontend::Update()
{
	...
	if (not_collapsed)
	{
		...
		else
		{
			...
			ImGui::ImageCopyable(*window, ImTextureRef(window->framebuffer_texture), SDL_SCALEMODE_PIXELART, destination_size, uv0 / uv_div, uv1 / uv_div);
