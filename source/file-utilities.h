...
private:
	...
	void CreateFileDialog(Window &window, const char *title, const char *default_filename, const Filters &filters, PopupCallback callback, bool save);

public:
	bool use_native_file_dialogs = true;

	void CreateOpenFileDialog(Window &window, const char *title, const char *default_filename, const Filters &filters, PopupCallback callback);
	void CreateSaveFileDialog(Window &window, const char *title, const char *default_filename, const Filters &filters, PopupCallback callback);
