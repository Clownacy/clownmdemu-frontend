...
bool DebugMemory::Display(const cc_u8l* const buffer, const std::size_t buffer_length)
{
#if 0
...
bool DebugMemory::Display(const cc_u16l* const buffer, const std::size_t buffer_length)
{
