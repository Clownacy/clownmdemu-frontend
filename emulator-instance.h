...
private:
	...
	static void PCMAudioCallback(void *user_data, std::size_t total_samples, void (*generate_pcm_audio)(const ClownMDEmu *clownmdemu, cc_s16l *sample_buffer, std::size_t total_samples));
